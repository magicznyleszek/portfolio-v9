...
{% include project/image.liquid dir=page.slug filename="hashtabber-01-logo.png" title="Simple logo of the project" %}

{% include project/image.liquid dir=page.slug filename="hashtabber-02-palette.png" title="Color palette" %}
...
{% include project/image.liquid dir=page.slug filename="hashtabber-03-diagram.png" title="Diagram" %}
...
{% include project/image.liquid dir=page.slug filename="hashtabber-04-website-1.png" %}

{% include project/image.liquid dir=page.slug filename="hashtabber-05-website-2.png" %}

{% include project/image.liquid dir=page.slug filename="hashtabber-06-website-3.png" %}

{% include project/image.liquid dir=page.slug filename="hashtabber-07-website-4.png" %}
